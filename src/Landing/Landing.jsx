          ...
          <Grid container spacing={5} alignItems='flex-end'>
            <Grid item xs={12} sm={6} md={6}>
              <Box pl={4} pr={4}>
                ...
                >
                  "In the digital era, doing business online is easy and
                  simplified. APIs and 3rd party APIs have been the center pivot
                  of all online interactions and integrations. Business powered
                  technology and innovation is the next big transformation. Yet,
                  API development is ages behind in bringing the citizen
                  developer empowerment. Designing an API anymore should be in
