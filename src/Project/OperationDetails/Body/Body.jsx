...
const StoredProcedureLabel = ({
  ...
  function handleToolTipOpen() {
    if (
      isHover[0] &&
      isHover[1] == storedProcedureLabelItem?.sourceName &&
      storedProcedureLabelItem?.sourceName.length > truncateLength
    ) {
      // console.log("it is true");
      setOpenTooltip(true);
    } else {
  ...
  // console.log(storedProcedureLabelItem?.sourceName);
  return (
    <ReactHoverObserver>
      {({ isHovering }) => {
        return (
              ...
              <div className='flex flex-row items-center justify-start w-full '>
                <div className='w-full grid grid-cols-5 gap-2 items-center '>
                  ...
                  <div className='flex justify-self-start items-center'>
                    ...
                    />
                    {storedProcedureLabelItem?.sourceName &&
                    !_.isEmpty(storedProcedureLabelItem?.sourceName) ? (
                      <Tooltip
                        title={storedProcedureLabelItem?.sourceName}
                        open={openTooltip}
                        onClose={handleToolTipOpen}
                        onOpen={handleToolTipOpen}
                        placement='left-start'
