...
import { useDeleteOperation } from './deleteOperationQuery';

const DeleteOperation = ({ pathId, resourceId, operation: { operationId, operationName }, onClose }) => {
    const {
    ...
    return (
        ...
        >
            ...
            <>
                <p className="px-4 pb-4 text-body2">{`Are you sure want to delete the operation “${operationName}”? Once deleted you can’t get it back.`}</p>
