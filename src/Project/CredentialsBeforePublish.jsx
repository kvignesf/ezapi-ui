  ...
  return (
    <div className='p-4'>
      <>
        ...
        <div
          className='p-4'
          style={{ height: "395px", overflowY: "scroll", overflowX: "hidden" }}
        >
          {/* <div className=' mb-6'>
            <Formik
              initialValues={{
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={6}>
                        ...
                        <Field
                          ...
                          error={(!isDefaultproj) && Boolean(errors.password)}
                          color="primary"
                          value={(isDefaultproj && dbType === "mssql") ? "S0mbari@2022" : (isDefaultproj && dbType === "mongo") ? "JRVvuh9D5V0IZxCW" : values.password}
                          variant="outlined"
