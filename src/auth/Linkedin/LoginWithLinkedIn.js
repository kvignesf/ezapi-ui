...
// export class LoginWithLinkedin extends Component {
//   static propTypes = {
...
//     const linkedInAuthenLink = `https://www.linkedin.com/oauth/v2/authorization?response_type=code&state=${state}${scopeParam}&client_id=${clientId}&redirect_uri=${encodeRedirectUri}`;
//     if (supportIE) {
