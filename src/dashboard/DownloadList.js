...
function createData(name, dbname, fat, carbs, protein) {
  return { name, dbname, fat, carbs, protein };
}

const rows = [
  createData('NasaTLE1', 'NasaTLE1__user__1601301353032'),
  createData('NasaTLE2', 'NasaTLE2__user__1601301353032'),
  createData('NasaTLE3', 'NasaTLE3__user__1601301353032'),
  createData('NasaTLE4', 'NasaTLE4__user__1601301353032'),
  createData('NasaTLE5', 'NasaTLE5__user__1601301353032'),
  createData('NasaTLE6', 'NasaTLE6__user__1601301353032'),
  createData('NasaTLE7', 'NasaTLE7__user__1601301353032'),
  createData('NasaTLE8', 'NasaTLE8__user__1601301353032'),
];
...
const headCells = [
  ...
  { id: 'dbname', numeric: true, disablePadding: false, label: 'DB Name' },
];
...
export default function DownloadList(props) {
  ...
  const handleDownload = (event, api, osType) => {
    ...
    const bodyUrlParams = new URLSearchParams([
      ...
      fetch(Constants.localURL + "/download?" + bodyUrlParams, requestOptions)
        .then(
          (res) => {
          return res.json();
        })
        .then(
          (result) => {
            if (result && result.success) {
              ...
              props.throwError(result.message);
            }
  ...
  const emptyRows = rowsPerPage - Math.min(rowsPerPage, props.apiList.length - page * rowsPerPage);
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <TableContainer>
          ...
          >
            <TableBody>
              {stableSort(props.apiList, getComparator(order, orderBy))
